...
This interactive tool catalogues the living plant collections across the college's garden areas, using hand-drawn maps with clickable zones. All plant data is stored in a single CSV file for easy editing.
...
├── plants.csv          # ← THE DATABASE — edit this file to update plants
...
You need a local server (the CSV won't load from `file://`):
